...
//MARK: - Basic
    let iYou = [
        Question(interrogative: "I", transcriotion: "[aɪ]", answers: ["Я", "Ты", "Мы", "Вы"], correctAnswerIndex: 0, sound: "i"),
        Question(interrogative: "You", transcriotion: "[juː]", answers: ["Ты", "Мы", "Я", "Она"], correctAnswerIndex: 0, sound: "you"),
        Question(interrogative: "You", transcriotion: "[juː]", answers: ["Я", "Он", "Вы", "Она"], correctAnswerIndex: 2, sound: "you"),
        Question(interrogative: "He", transcriotion: "[hiː]", answers: ["Она", "Они", "Ты", "Он"], correctAnswerIndex: 3, sound: "he"),
        Question(interrogative: "She", transcriotion: "[ʃiː]", answers: ["Он", "Она", "Я", "Вы"], correctAnswerIndex: 1, sound: "she"),
        Question(interrogative: "It", transcriotion: "[ɪt]", answers: ["Вы", "Они", "Оно", "Он"], correctAnswerIndex: 2, sound: "it"),
        Question(interrogative: "They", transcriotion: "[ðeɪ]", answers: ["Она", "Они", "Оно", "Мы"], correctAnswerIndex: 1, sound: "they"),
        Question(interrogative: "We", transcriotion: "[wiː]", answers: ["Оно", "Ты", "Вы", "Мы"], correctAnswerIndex: 3, sound: "we")
    ]
    let iYouComplex = [
        Question(interrogative: "My", transcriotion: "[maɪ]", answers: ["Мне", "Мой", "Мы", "Я"], correctAnswerIndex: 1, sound: "my"),
        Question(interrogative: "Me", transcriotion: "[miː]", answers: ["Я", "Мой", "Мы", "Мне"], correctAnswerIndex: 3, sound: "me"),
        Question(interrogative: "Your", transcriotion: "[jɔː]", answers: ["Тебе (Вам)", "Его", "Твой (Ваш)", "Ему"], correctAnswerIndex: 2, sound: "your"),
        Question(interrogative: "You", transcriotion: "[juː]", answers: ["Тебе (Вам)", "Ему", "Его", "Твой (Ваш)"], correctAnswerIndex: 0, sound: "you"),
        Question(interrogative: "Our", transcriotion: "[ˈaʊə]", answers: ["Им", "Нам", "Его", "Наш"], correctAnswerIndex: 3, sound: "our"),
        Question(interrogative: "Us", transcriotion: "[us]", answers: ["Ему", "Наш", "Нам", "Его"], correctAnswerIndex: 2, sound: "us"),
        Question(interrogative: "Their", transcriotion: "[ðeə]", answers: ["Их", "Они", "Его", "Им"], correctAnswerIndex: 0, sound: "their"),
        Question(interrogative: "Them", transcriotion: "[ðeɪ]", answers: ["Их", "Им", "Ему", "Они"], correctAnswerIndex: 1, sound: "them"),
        Question(interrogative: "His", transcriotion: "[hɪz]", answers: ["Его", "Её", "Ему", "Ей"], correctAnswerIndex: 0, sound: "his"),
        Question(interrogative: "Her", transcriotion: "[hɜː]", answers: ["Ей", "Его", "Её", "Ему"], correctAnswerIndex: 2, sound: "her")
    ]
    let hello = [
        Question(interrogative: "Hello", transcriotion: "[həˈləʊ]", answers: ["Пока", "Привет", "До свидания", "Добрый день"], correctAnswerIndex: 1, sound: "hello"),
        Question(interrogative: "Hi", transcriotion: "[haɪ]", answers: ["Привет", "До свидания", "Пока", "Добрый день"], correctAnswerIndex: 0, sound: "hi"),
        Question(interrogative: "Bye", transcriotion: "[baɪ]", answers: ["До свидания", "Добрый день", "Привет", "Пока"], correctAnswerIndex: 3, sound: "bye"),
        Question(interrogative: "Good Morning", transcriotion: "[ɡʊd ˈmɔːnɪŋ]", answers: ["Добрый день", "Привет", "Доброе утро", "Добрый вечер"], correctAnswerIndex: 2, sound: "goodMorning"),
        Question(interrogative: "Good Afternoon", transcriotion: "[gʊd ɑːftəˈnuːn]", answers: ["Добрый день", "Добрый вечер", "Привет", "Доброе утро"], correctAnswerIndex: 0, sound: "goodAfternoon"),
        Question(interrogative: "Good Evening", transcriotion: "[gʊd ˈiːvnɪŋ]", answers: ["Привет", "Добрый вечер", "Доброе утро", "Добрый день"], correctAnswerIndex: 1, sound: "goodEvening"),
        Question(interrogative: "Good Night", transcriotion: "[gʊd naɪt]", answers: ["Добрый день", "Привет", "Спокойной ночи", "Добрый вечер"], correctAnswerIndex: 2, sound: "goodNight"),
        Question(interrogative: "Goodbye", transcriotion: " [gʊdˈbaɪ]", answers: ["Привет", "Пока", "Добрый день", "До свидания"], correctAnswerIndex: 3, sound: "goodbye"),
        Question(interrogative: "Sorry", transcriotion: "[ˈsɒrɪ]", answers: ["Прошу прощения", "Спасибо", "Извините", "Пожалуйста"], correctAnswerIndex: 2, sound: "sorry"),
        Question(interrogative: "Excuse me", transcriotion: "[ɪksˈkjuːs miː]", answers: ["Прошу прощения", "Пожалуйста", "Спасибо", "Извините"], correctAnswerIndex: 0, sound: "excuseMe"),
        Question(interrogative: "Thank You", transcriotion: "[θæŋk juː]", answers: ["Извините", "Прошу прощения", "Пожалуйста", "Спасибо"], correctAnswerIndex: 3, sound: "thankYou"),
        Question(interrogative: "Please", transcriotion: "[pliːz]", answers: ["Прошу прощения", "Пожалуйста", "Извините", "Спасибо"], correctAnswerIndex: 1, sound: "please")
    ]
    let question = [
        Question(interrogative: "Who?", transcriotion: "[huː]", answers: ["Где?", "Кто?", "Когда?", "Что?"], correctAnswerIndex: 1, sound: "who"),
        Question(interrogative: "What?", transcriotion: "[wɒt]", answers: ["Когда?", "Кто?", "Что?", "Как?"], correctAnswerIndex: 2, sound: "what"),
        Question(interrogative: "When?", transcriotion: "[wen]", answers: ["Что?", "Где?", "Кто?", "Когда?"], correctAnswerIndex: 3, sound: "when"),
        Question(interrogative: "Where?", transcriotion: "[weə]", answers: ["Где?", "Кто?", "Когда?", "Что?"], correctAnswerIndex: 0, sound: "where"),
        Question(interrogative: "How?", transcriotion: "[haʊ]", answers: ["Что?", "Как?", "Где?", "Когда?"], correctAnswerIndex: 1, sound: "how"),
        Question(interrogative: "How much?", transcriotion: "[haʊ mʌʧ]", answers: ["С кем?", "Чей?", "Сколько?", "Как долго?"], correctAnswerIndex: 2, sound: "howMuch"),
        Question(interrogative: "Why?", transcriotion: "[waɪ]", answers: ["Как часто?", "Как?", "Какой?", "Почему?"], correctAnswerIndex: 3, sound: "why"),
        Question(interrogative: "Whose?", transcriotion: "[huːz]", answers: ["Чей?", "Кто?", "Как долго?", "С кем?"], correctAnswerIndex: 0, sound: "whose"),
        Question(interrogative: "Which?", transcriotion: "[wɪʧ]", answers: ["Как?", "Какой?", "Сколько?", "Как часто?"], correctAnswerIndex: 1, sound: "which"),
        Question(interrogative: "How long?", transcriotion: "[haʊ lɒŋ]", answers: ["Когда?", "Чей?", "Как долго?", "С кем?"], correctAnswerIndex: 2, sound: "howLong"),
        Question(interrogative: "How often?", transcriotion: "[haʊ ˈɒf(t)ən]", answers: ["Какой?", "Сколько?", "Как?", "Как часто?"], correctAnswerIndex: 3, sound: "howOften"),
        Question(interrogative: "With whom?", transcriotion: "[wɪð huːm]", answers: ["С кем?", "Как долго?", "Чей?", "Когда?"], correctAnswerIndex: 0, sound: "withWhom"),
        Question(interrogative: "By what time?", transcriotion: "[baɪ wɒt taɪm]", answers: ["Как часто?", "В котором часу?", "Какой?", "Сколько?"], correctAnswerIndex: 1, sound: "byWhatTime")
    ]
    let color = [
        Question(interrogative: "Red", transcriotion: "[red]", answers: ["Красный", "Розовый", "Коричневый", "Зелёный"], correctAnswerIndex: 0, sound: "red"),
        Question(interrogative: "Orange", transcriotion: "[ˈɒrɪnʤ]", answers: ["Светлый", "Оранжевый", "Серый", "Белый"], correctAnswerIndex: 1, sound: "orange"),
        Question(interrogative: "Yellow", transcriotion: "[ˈjeləʊ]", answers: ["Фиолетовый", "Тёмный", "Жёлтый", "Чёрный"], correctAnswerIndex: 2, sound: "yellow"),
        Question(interrogative: "Green", transcriotion: "[griːn]", answers: ["Розовый", "Красный", "Коричневый", "Зелёный"], correctAnswerIndex: 3, sound: "green"),
        Question(interrogative: "Blue", transcriotion: "[bluː]", answers: ["Синий", "Серый", "Оранжевый", "Белый"], correctAnswerIndex: 0, sound: "blue"),
        Question(interrogative: "Purple", transcriotion: "[pɜːpl]", answers: ["Тёмный", "Фиолетовый", "Чёрный", "Жёлтый"], correctAnswerIndex: 1, sound: "purple"),
        Question(interrogative: "Brown", transcriotion: "[braʊn]", answers: ["Красный", "Зелёный", "Коричневый", "Розовый"], correctAnswerIndex: 2, sound: "brown"),
        Question(interrogative: "White", transcriotion: "[waɪt]", answers: ["Светлый", "Оранжевый", "Серый", "Белый"], correctAnswerIndex: 3, sound: "white"),
        Question(interrogative: "Black", transcriotion: "[blæk]", answers: ["Чёрный", "Тёмный", "Жёлтый", "Фиолетовый"], correctAnswerIndex: 0, sound: "black"),
        Question(interrogative: "Pink", transcriotion: "[pɪŋk]", answers: ["Светлый", "Розовый", "Красный", "Коричневый"], correctAnswerIndex: 1, sound: "pink"),
        Question(interrogative: "Gray", transcriotion: "[greɪ]", answers: ["Оранжевый", "Белый", "Серый", "Зелёный"], correctAnswerIndex: 2, sound: "gray"),
        Question(interrogative: "Dark", transcriotion: "[dɑːk]", answers: ["Чёрный", "Жёлтый", "Фиолетовый", "Тёмный"], correctAnswerIndex: 3, sound: "dark"),
        Question(interrogative: "Light", transcriotion: "[laɪt]", answers: ["Светлый", "Коричневый", "Красный", "Розовый"], correctAnswerIndex: 0, sound: "light")
    ]
    let geometricShape = [
        Question(interrogative: "Circle", transcriotion: "[sɜːkl]", answers: ["Круг", "Точка", "Овал", "Конус"], correctAnswerIndex: 0, sound: "circle"),
        Question(interrogative: "Triangle", transcriotion: "[ˈtraɪæŋgl]", answers: ["Квадрат", "Треугольник", "Прямоугольник", "Ромб"], correctAnswerIndex: 1, sound: "triangle"),
        Question(interrogative: "Square", transcriotion: "[skweə]", answers: ["Размер", "Прямоугольник", "Квадрат", "Куб"], correctAnswerIndex: 2, sound: "square"),
        Question(interrogative: "Point", transcriotion: "[pɔɪnt]", answers: ["Точка", "Квадрат", "Прямая", "Круг"], correctAnswerIndex: 0, sound: "point"),
        Question(interrogative: "Angle", transcriotion: "[æŋgl]", answers: ["Прямая", "Угол", "Прямоугольник", "Квадрат"], correctAnswerIndex: 1, sound: "angle"),
        Question(interrogative: "Size", transcriotion: "[saɪz]", answers: ["Высота", "Ширина", "Размер", "Прямая"], correctAnswerIndex: 2, sound: "size"),
        Question(interrogative: "Width", transcriotion: "[wɪdθ]", answers: ["Точка", "Размер", "Высота", "Ширина"], correctAnswerIndex: 3, sound: "width"),
        Question(interrogative: "Height", transcriotion: "[haɪt]", answers: ["Высота", "Угол", "Размер", "Ширина"], correctAnswerIndex: 0, sound: "height"),
        Question(interrogative: "Line", transcriotion: "[laɪn]", answers: ["Высота", "Прямая", "Конус", "Точка"], correctAnswerIndex: 1, sound: "line"),
        Question(interrogative: "Pyramid", transcriotion: "[ˈpɪrəmɪd]", answers: ["Ромб", "Треугольник", "Пирамида", "Конус"], correctAnswerIndex: 2, sound: "pyramid"),
        Question(interrogative: "Cube", transcriotion: "[kjuːb]", answers: ["Прямоугольник", "Квадрат", "Треугольник", "Куб"], correctAnswerIndex: 3, sound: "cube"),
        Question(interrogative: "Star", transcriotion: "[stɑː]", answers: ["Звезда", "Пирамида", "Ромб", "Размер"], correctAnswerIndex: 0, sound: "star"),
        Question(interrogative: "Rhombus", transcriotion: "[ˈrɒmbəs]", answers: ["Звезда", "Ромб", "Пирамида", "Треугольник"], correctAnswerIndex: 1, sound: "rhombus"),
        Question(interrogative: "Oval", transcriotion: "[ˈəʊvəl]", answers: ["Конус", "Круг", "Овал", "Точка"], correctAnswerIndex: 2, sound: "oval"),
        Question(interrogative: "Rectangle", transcriotion: "[ˈrektæŋgl]", answers: ["Треугольник", "Размер", "Квадрат", "Прямоугольник"], correctAnswerIndex: 3, sound: "rectangle"),
        Question(interrogative: "Cone", transcriotion: "[kəʊn]", answers: ["Конус", "Овал", "Точка", "Круг"], correctAnswerIndex: 0, sound: "cone")
    ]
//MARK: - Time
    let number = [
...
//MARK: - Food
    let aboutFood = [
        ...
        Question(interrogative: "Fruit", transcriotion: "[fruːt]", answers: ["Фрукт", "Морепродукты", "Ягода", "Орех"], correctAnswerIndex: 0, sound: "fruit"),
...
class Question {
    ...
    fileprivate let transcriotion: String
    fileprivate let answers: [String]
    fileprivate let correctAnswerIndex: Int
    fileprivate let sound: String
    
    init(interrogative: String, transcriotion: String, answers: [String], correctAnswerIndex: Int, sound: String) {
        self.interrogative = interrogative
        self.transcriotion = transcriotion
